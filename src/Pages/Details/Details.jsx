        ...
        <div className='max-w-7xl mx-auto'>
            <div className='space-y-4 bg-white rounded-2xl text-center py-10 my-5'>
                ...
                <p className='opacity-70 w-4/5 mx-auto'>
                    Explore detailed information about each doctor, including their educational background, area of specialization, years of experience, current workplace, consultation fees, and available days for appointments. This profile helps you make informed <br /> decisions when selecting the right healthcare professional for your specific medical needs.
                </p>
            </div>
            ...
            <div className='bg-white rounded-2xl py-12 px-10 my-6'>
                ...
                <Link>
                    <button className='btn btn-primary w-full font-medium text-lg py-5 bg-[#176AE5] text-[#FFFFFF] rounded-3xl mt-6'>

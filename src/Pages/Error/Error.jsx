        ...
        <div>
            ...
            <div className="flex flex-col items-center justify-center p-4 text-center">
                <img
                    src={errorImage}
                    alt="Error"
                    className="max-w-xl rounded-xl mb-4"
                />
                <h2 className="text-4xl font-bold text-red-400 mb-3">Oops! Page Not Found</h2>
                ...
                <Link
                    to="/"
                    className="inline-flex items-center gap-2 bg-[#176AE5] text-white font-semibold px-6 py-3 rounded-3xl hover:bg-[#145dc4] transition-all"
                >
                    <FaArrowLeft /> Go Home
                </Link>
            </div>
